      ...
      {showHelp && (
        <div className="yfm-help">
          ...
          <ul>
            ...
            <li><code>&#123;% note info %&#125;Текст&#123;% endnote %&#125;</code> – заметка info</li>
            <li><code>&#123;% note warning %&#125;Текст&#123;% endnote %&#125;</code> – предупреждение</li>
            <li><code>&#123;% note important %&#125;Текст&#123;% endnote %&#125;</code> – важно</li>
            <li><code>&#123;% tabs %&#125;&#123;% tab "Вкладка" %&#125;...&#123;% endtab %&#125;&#123;% endtabs %&#125;</code> – вкладки</li>
            <li><code>&#123;% cut "Заголовок" %&#125;...&#123;% endcut %&#125;</code> – сворачиваемый блок</li>
          </ul>
        </div>
      )}
    </div>
